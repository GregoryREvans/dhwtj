...
maker = evans.SegmentMaker(
    ...
    name_staves=True,
    fermata_measures=dhwtj.fermata_measures_04,
    commands=[
        evans.call(
            "Global Context",
            dhwtj.make_proportaional_global_context,
        ...
        evans.MusicCommand(
            ...
            dhwtj.E_rhythm(stage=1, indices=[0, 1, 3], period=4, seed=1),
            evans.PitchHandler(
                [
        ...
        evans.MusicCommand(
            ...
            dhwtj.E_rhythm(stage=1, indices=[0, 1, 3], period=5, seed=2),
            evans.PitchHandler(
                [
                    str(abjad.StaffPosition(0).to_pitch(abjad.Clef("percussion"))),
                    str(abjad.StaffPosition(2).to_pitch(abjad.Clef("percussion"))),
        ...
        evans.MusicCommand(
            [("percussion 3 voice", (0, 11))],
            dhwtj.E_rhythm(stage=1, indices=[0, 1, 3], period=6, seed=3),
            evans.PitchHandler(
                [
                    str(abjad.StaffPosition(0).to_pitch(abjad.Clef("percussion"))),
                    str(abjad.StaffPosition(2).to_pitch(abjad.Clef("percussion"))),
        ...
        evans.MusicCommand(
            [
                ("percussion 4 voice", (1, 11)),
            ],
            dhwtj.E_rhythm(stage=1, indices=[0, 1, 3], period=7, seed=4),
            evans.PitchHandler(
                [
                    str(abjad.StaffPosition(0).to_pitch(abjad.Clef("percussion"))),
                    str(abjad.StaffPosition(-2).to_pitch(abjad.Clef("percussion"))),
    ...
    time_signatures=dhwtj.signatures_04,
    clef_handlers=None,
