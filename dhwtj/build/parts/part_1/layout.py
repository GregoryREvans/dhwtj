...
breaks = evans.Breaks(
    evans.Page(
        ...
        evans.System(measures=8, lbsd=(130, "(13 23 23 23)"), x_offset=1),
        evans.System(measures=7, lbsd=(160, "(13 23 23 23)"), x_offset=1),
    ),
    evans.Page(
        evans.System(measures=7, lbsd=(20, "(13 23 23 23)"), x_offset=1),

        evans.System(measures=3, lbsd=(50, "(13 23 23 23)"), x_offset=1),
        evans.System(measures=2, lbsd=(70, "(13 23 23 23)"), x_offset=1),
        evans.System(measures=3, lbsd=(90, "(13 23 23 23)"), x_offset=1),
        evans.System(measures=3, lbsd=(110, "(13 23 23 23)"), x_offset=1),

        evans.System(measures=6, lbsd=(140, "(13 23 23 23)"), x_offset=1),
        evans.System(measures=4, lbsd=(160, "(13 23 23 23)"), x_offset=1),
    ),
    evans.Page(
    ...
    evans.Page(
        ...
        evans.System(measures=6, lbsd=(110, "(13 23 23 23)"), x_offset=1),
        evans.System(measures=6, lbsd=(140, "(13 23 23 23)"), x_offset=1),
    ),
    evans.Page(
        evans.System(measures=7, lbsd=(20, "(13 23 23 23)"), x_offset=1),
        ...
        evans.System(measures=6, lbsd=(80, "(13 23 23 23)"), x_offset=1),
        evans.System(measures=2, lbsd=(110, "(13 23 23 23)"), x_offset=1),
    ),
